...
function Privacy() {
  return (
    <div className="shipping flex flex-colalign-middle justify-center items-center text-center   text-white mt-32">
      ...
      <div className="shipping__details text-left ">
        ...
        <div className="shipping__info flex pb-3">
          ...
          <div className="p-10 sm:w-1/2 text-center bg-gray-800/75 rounded-md">
            <ul className="pb-5">
        ...
        <div className="shipping__info flex pb-3">
          ...
          <ul
            className="p-10 sm:w-1/2 text-center bg-gray-800/75 rounded-md"
            style={{
              listStyleType: "square",
            }}
          >
